...
impl TestApp {
    ...
    pub async fn get_pushlish_newsletter(&self) -> reqwest::Response {
        self.api_client
    ...
    pub async fn get_pushlish_newsletter_html(&self) -> String {
        self.get_pushlish_newsletter().await.text().await.unwrap()
    }
